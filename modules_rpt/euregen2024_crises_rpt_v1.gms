Set
crises_set /nuc,irnw,rnw,bio,bionochp,biochp,chp,wind,sol,hydro,gas,coal,lign,oil,gasnochp,coalnochp,lignnochp,oilnochp,gaschp,coalchp,lignchp,oilchp,dirty,dirtynochp,dirtychp,dirtynolig,import,export,resv,pump/
;
...
sharecap_crises(crises_set,r,t)
shareafcap_crises(crises_set,r,t)
sharegen_crises(crises_set,r,t)
...
$if not  set days   sharecap_crises(crises_set,r,t)$(loadmax(r,t) > 0) = cap_crises(crises_set,r,t) / loadmax(r,t) + eps ;
$if not  set days   shareafcap_crises(crises_set,r,t)$(loadmax(r,t) > 0) = afcap_crises(crises_set,r,t) / loadmax(r,t) + eps ;
$if      set days   sharecap_crises(crises_set,r,t)$(loadmax_d(r,t) > 0) = cap_crises(crises_set,r,t) / loadmax_d(r,t) + eps ;
$if      set days   shareafcap_crises(crises_set,r,t)$(loadmax_d(r,t) > 0) = afcap_crises(crises_set,r,t) / loadmax_d(r,t) + eps ;
sharegen_crises(crises_set,r,t)$(daref(r,t) > 0) = gen_crises(crises_set,r,t) / daref(r,t) + eps ;
...
discostco2_tyrpt(tyrpt,r,t)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(ivrt(i,v,r,t), XTWHL(i,v,r,t)))) > 0) = sum(xtyperpt(tyrpt,type), sum(idef(i,type),  sum(ivrt(i,v,r,t), discostco2(i,v,r,t) * XTWHL(i,v,r,t)))) / sum(xtyperpt(tyrpt,type), sum(idef(i,type),  sum(ivrt(i,v,r,t), XTWHL(i,v,r,t)))) ;
discostco2_nochp_tyrpt(tyrpt,r,t)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(ivrt(nochp(i),v,r,t), XTWHL(i,v,r,t)))) > 0) = sum(xtyperpt(tyrpt,type), sum(idef(i,type),  sum(ivrt(nochp(i),v,r,t), discostco2(i,v,r,t) * XTWHL(i,v,r,t)))) / sum(xtyperpt(tyrpt,type), sum(idef(i,type),  sum(ivrt(nochp(i),v,r,t), XTWHL(i,v,r,t)))) ;
discostco2_chp_tyrpt(tyrpt,r,t)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(ivrt(chp(i),v,r,t), XTWHL(i,v,r,t)))) > 0) = sum(xtyperpt(tyrpt,type), sum(idef(i,type),  sum(ivrt(chp(i),v,r,t), discostco2(i,v,r,t) * XTWHL(i,v,r,t)))) / sum(xtyperpt(tyrpt,type), sum(idef(i,type),  sum(ivrt(chp(i),v,r,t), XTWHL(i,v,r,t)))) ;

discostco2_gas(r,t)$(sum(idef(i,type), sum(ivrt(gas(i),v,r,t), XTWHL(i,v,r,t))) > 0) = sum(idef(i,type),  sum(ivrt(gas(i),v,r,t), discostco2(i,v,r,t) * XTWHL(i,v,r,t))) / sum(idef(i,type),  sum(ivrt(gas(i),v,r,t), XTWHL(i,v,r,t))) ;
discostco2_gasnochp(r,t)$(sum(idef(nochp(i),type), sum(ivrt(gas(i),v,r,t), XTWHL(i,v,r,t))) > 0) = sum(idef(nochp(i),type),  sum(ivrt(gas(i),v,r,t), discostco2(i,v,r,t) * XTWHL(i,v,r,t))) / sum(idef(nochp(i),type),  sum(ivrt(gas(i),v,r,t), XTWHL(i,v,r,t))) ;
discostco2_gaschp(r,t)$(sum(idef(chp(i),type), sum(ivrt(gas(i),v,r,t), XTWHL(i,v,r,t))) > 0) = sum(idef(chp(i),type),  sum(ivrt(gas(i),v,r,t), discostco2(i,v,r,t) * XTWHL(i,v,r,t))) / sum(idef(chp(i),type),  sum(ivrt(gas(i),v,r,t), XTWHL(i,v,r,t))) ;
...
marginal(s,ivrt(i,v,r,t))$(XL(s,i,v,r,t) < (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) * XC.L(i,v,r,t) and XL(s,i,v,r,t) > 0 and not irnw(i)) = YES ;
$if      set minmax marginal(s,ivrt(nuc(i),v,r,t))$(XL(s,i,v,r,t) < afmax(s,i,v,r,t) * XC.L(i,v,r,t) and XL(s,i,v,r,t) ge afmin(s,i,v,r,t) * XC.L(i,v,r,t)) = YES ;
$if      set minmax marginal(s,ivrt(i,v,r,t))$(XL(s,i,v,r,t) < afmax(s,i,v,r,t) * XC.L(i,v,r,t) and XL(s,i,v,r,t) ge afmin(s,i,v,r,t) * XC.L(i,v,r,t) and sameas(i,"Bioenergy")) = YES ;

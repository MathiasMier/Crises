...
$if      set    fromsixd        numberdays = 6 ;
$if      set    fromonefived    numberdays = 15 ;
...
dareftest(r,t) = sum((sd,hd), days(sd) * load_d_int(sd,hd,r,t)) * 1e-3 ;
dareftest_sec(r,t,l) = sum((sd,hd), days(sd) * load_sec_d_int(sd,hd,r,t,l)) * 1e-3 ;
irnwflhtest(i,v,r) = sum((sd,hd), days(sd) * vrsc_d_int(sd,hd,i,v,r)) ;
irnwflhtest_exi(i,r,t) = sum((sd,hd), days(sd) * vrsc_exi_d_int(sd,hd,i,r,t)) ;

*loadcorr_d(r,t)$(dareftest(r,t) > 0) = daref(r,t) / dareftest(r,t) ;
*loadcorr_sec_d(r,t,l)$(dareftest_sec(r,t,l) > 0) = daref_sec(r,t,l) / dareftest_sec(r,t,l) ;
*vrsccorr_d(i,v,r)$(irnwflhtest(i,v,r) > 0) = irnwflh_h(i,v,r) / irnwflhtest(i,v,r) ;
*vrsccorr_exi_d(i,r,t)$(irnwflhtest_exi(i,r,t) > 0) = irnwflh_exi_h(i,r,t) / irnwflhtest_exi(i,r,t) ;
...
daref_ire(r,t2023(t))$(sameas(r,"Ireland")) = daref(r,"2021") * sum(rr$(not sameas(rr,"Ireland")), daref(rr,t)) / sum(rr$(not sameas(rr,"Ireland")), daref(rr,"2021")) ;
...
load_d(sd,hd,r,"2022")$(sameas(r,"Ireland")) = round(load_d(sd,hd,r,"2021") * daref_ire(r,"2022") / daref_ire(r,"2021"),4) ;
load_d(sd,hd,r,"2023")$(sameas(r,"Ireland")) = round(load_d(sd,hd,r,"2021") * daref_ire(r,"2023") / daref_ire(r,"2021"),4) ;
load_d(sd,hd,r,topt2024(t))$(sameas(r,"Ireland")) = round(load_d(sd,hd,r,"2021") * daref_ire(r,t) / daref_ire(r,"2021"),4) ;
daref("Ireland",t) = sum((sd,hd), days(sd) * load_d(sd,hd,"Ireland",t)) * 1e-3  ;
...
$if     set loadnormal  load_d_int(sd,hd,r,t)$(not sameas(r,"Ireland")) = load_d(sd,hd,r,t) ;
$if     set loadnormal  load_d(sd,hd,r,t)$(not sameas(r,"Ireland")) = load_d_int(sd,hd,r,t) * daref_int(r,t) / daref_org(r,t) ; 
$if     set loadnormal  daref(r,t)$(not sameas(r,"Ireland")) = sum((sd,hd), days(sd) * load_d(sd,hd,r,t)) * 1e-3 ;
...
dareftest2(r,t) = sum((sd,hd), days(sd) * load_d(sd,hd,r,t)) * 1e-3 ;
dareftest2_sec(r,t,l) = sum((sd,hd), days(sd) * load_sec_d(sd,hd,r,t,l)) * 1e-3 ;
irnwflhtest2(i,v,r) = sum((sd,hd), days(sd) * vrsc_d(sd,hd,i,v,r)) ;
irnwflhtest2_exi(i,r,t) = sum((sd,hd), days(sd) * vrsc_exi_d(sd,hd,i,r,t)) ;
...
$if      set fromfixd       sdnum(sd)$(sd.val eq 10) = YES ;
$if      set fromonefived   sdnum(sd)$(sd.val eq 37) = YES ;
...
$if     set chp af_d(sd,hd,ivrt(chp(i),oldv(v),r,told(t))) = sum(sdm(sd,m), afm_chp(m,i,r,t)) ;
...
*gen_afmax_pump(r,t) = sum(jvrt(jpump(j),v,r,t), sum((sd,hd), days(sd) * glifetime(j,v,r,t) * gcapt(j,v,r,t) * dchrgpen(j,v,r) * (1 + (gafmaxnv_d(sd,hd,j,r,t)-1)$gafmaxnv_d(sd,hd,j,r,t)))) * 1e-3 ;
gen_afmax_resv(r,t) = sum(jvrt(jres(j),v,r,t),   sum((sd,hd), days(sd) * glifetime(j,v,r,t) * gcapt(j,v,r,t) * dchrgpen(j,v,r) * (1 + (gafmaxnv_d(sd,hd,j,r,t)-1)$gafmaxnv_d(sd,hd,j,r,t)))) * 1e-3 ;
...
afmin_nochp_int_d(sd,hd,i,v,r,t)
afmax_nochp_int_d(sd,hd,i,v,r,t)
;

* * Availability parameter correction 
* Interim availability
af_int_d(sd,hd,ivrt(i,oldv(v),r,t))               = af_d(sd,hd,i,v,r,t) ;
af_chp_int_d(sd,hd,ivrt_chp(i,oldv(v),r,t))       = af_chp_d(sd,hd,i,v,r,t) ;
af_nochp_int_d(sd,hd,ivrt(nochp(i),oldv(v),r,t))  = af_nochp_d(sd,hd,i,v,r,t) ;
...
* Other technologies
$if not  set nucmustrun     af_d(sd,hd,ivrt(nuc(i),oldv(v),r,t))$(gen_co_nucl(r,t) > 1)  = (1 + (af_int_d(sd,hd,i,v,r,t)-1)$af_int_d(sd,hd,i,v,r,t)) * gen_co_nucl(r,t) ;
$if      set nucmustrun     af_d(sd,hd,ivrt(nuc(i),oldv(v),r,t)) = (1 + (af_int_d(sd,hd,i,v,r,t)-1)$af_int_d(sd,hd,i,v,r,t)) * gen_co_nucl(r,t) ;
...
$if not  set biomustrun     af_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t))$(gen_co_biom(r,t) > 1)   = (1 + (af_int_d(sd,hd,i,v,r,t)-1)$af_int_d(sd,hd,i,v,r,t)) * gen_co_biom(r,t) ;
$if      set biomustrun     af_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = (1 + (af_int_d(sd,hd,i,v,r,t)-1)$af_int_d(sd,hd,i,v,r,t)) * gen_co_biom(r,t) ;
* CHP 
$if not  set chpmustrun     af_chp_d(sd,hd,ivrt_chp(gas(i),oldv(v),r,t))$(gen_co_chp_ngas(r,t) > 1) = (1 + (af_chp_int_d(sd,hd,i,v,r,t)-1)$af_chp_int_d(sd,hd,i,v,r,t)) * gen_co_chp_ngas(r,t) ;
$if not  set chpmustrun     af_chp_d(sd,hd,ivrt_chp(coa(i),oldv(v),r,t))$(gen_co_chp_coal(r,t) > 1) = (1 + (af_chp_int_d(sd,hd,i,v,r,t)-1)$af_chp_int_d(sd,hd,i,v,r,t)) * gen_co_chp_coal(r,t) ;
$if not  set chpmustrun     af_chp_d(sd,hd,ivrt_chp(lig(i),oldv(v),r,t))$(gen_co_chp_lign(r,t) > 1) = (1 + (af_chp_int_d(sd,hd,i,v,r,t)-1)$af_chp_int_d(sd,hd,i,v,r,t)) * gen_co_chp_lign(r,t) ;
$if not  set chpmustrun     af_chp_d(sd,hd,ivrt_chp(bio(i),oldv(v),r,t))$(gen_co_chp_biom(r,t) > 1) = (1 + (af_chp_int_d(sd,hd,i,v,r,t)-1)$af_chp_int_d(sd,hd,i,v,r,t)) * gen_co_chp_biom(r,t) ;
$if not  set chpmustrun     af_chp_d(sd,hd,ivrt_chp(oil(i),oldv(v),r,t))$(gen_co_chp_oil(r,t) > 1) = (1 + (af_chp_int_d(sd,hd,i,v,r,t)-1)$af_chp_int_d(sd,hd,i,v,r,t)) * gen_co_chp_oil(r,t) ;
$if      set chpmustrun     af_chp_d(sd,hd,ivrt_chp(gas(i),oldv(v),r,t)) = af_chp_int_d(sd,hd,i,v,r,t) * gen_co_chp_ngas(r,t) ;
$if      set chpmustrun     af_chp_d(sd,hd,ivrt_chp(coa(i),oldv(v),r,t)) = af_chp_int_d(sd,hd,i,v,r,t) * gen_co_chp_coal(r,t) ;
$if      set chpmustrun     af_chp_d(sd,hd,ivrt_chp(lig(i),oldv(v),r,t)) = af_chp_int_d(sd,hd,i,v,r,t) * gen_co_chp_lign(r,t) ;
$if      set chpmustrun     af_chp_d(sd,hd,ivrt_chp(bio(i),oldv(v),r,t)) = af_chp_int_d(sd,hd,i,v,r,t) * gen_co_chp_biom(r,t) ;
$if      set chpmustrun     af_chp_d(sd,hd,ivrt_chp(oil(i),oldv(v),r,t)) = af_chp_int_d(sd,hd,i,v,r,t) * gen_co_chp_oil(r,t) ;
* NOCHP
af_nochp_d(sd,hd,ivrt_nochp(gas(i),oldv(v),r,t))$(gen_co_nochp_ngas(r,t) > 1) = (1 + (af_nochp_int_d(sd,hd,i,v,r,t)-1)$af_nochp_int_d(sd,hd,i,v,r,t)) * gen_co_nochp_ngas(r,t) ;
af_nochp_d(sd,hd,ivrt_nochp(coa(i),oldv(v),r,t))$(gen_co_nochp_coal(r,t) > 1) = (1 + (af_nochp_int_d(sd,hd,i,v,r,t)-1)$af_nochp_int_d(sd,hd,i,v,r,t)) * gen_co_nochp_coal(r,t) ;
af_nochp_d(sd,hd,ivrt_nochp(lig(i),oldv(v),r,t))$(gen_co_nochp_lign(r,t) > 1) = (1 + (af_nochp_int_d(sd,hd,i,v,r,t)-1)$af_nochp_int_d(sd,hd,i,v,r,t)) * gen_co_nochp_lign(r,t) ;
$if not  set biomustrun     af_nochp_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t))$(gen_co_nochp_biom(r,t) > 1) = (1 + (af_nochp_int_d(sd,hd,i,v,r,t)-1)$af_nochp_int_d(sd,hd,i,v,r,t)) *  gen_co_nochp_biom(r,t) ;
$if      set biomustrun     af_nochp_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = (1 + (af_nochp_int_d(sd,hd,i,v,r,t)-1)$af_nochp_int_d(sd,hd,i,v,r,t)) *  gen_co_nochp_biom(r,t) ;
af_nochp_d(sd,hd,ivrt_nochp(oil(i),oldv(v),r,t))$(gen_co_nochp_oil(r,t) > 1) = (1 + (af_nochp_int_d(sd,hd,i,v,r,t)-1)$af_nochp_int_d(sd,hd,i,v,r,t)) * gen_co_nochp_oil(r,t) ;
* NOCHP min/max issues
...
afmin_int_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = afmin_d(sd,hd,i,v,r,t) ;
afmax_int_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = afmax_d(sd,hd,i,v,r,t) ;
afmin_nochp_int_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = afmin_nochp_d(sd,hd,i,v,r,t) ;
afmax_nochp_int_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = afmax_nochp_d(sd,hd,i,v,r,t) ;
* Availability 2024+
af_d(sd,hd,ivrt(i,oldv(v),r,topt2024(t)))                     = af_int_d(sd,hd,i,v,r,"2023") ;
$if not  set frnucnormal    af_d(sd,hd,ivrt(nuc(i),oldv(v),"France",topt2024(t)))         = af_int_d(sd,hd,i,v,"France","2023") * 393.134 / 354.105 ;
af_chp_d(sd,hd,ivrt_chp(i,oldv(v),r,topt2024(t)))             = af_chp_int_d(sd,hd,i,v,r,"2023") ;
af_nochp_d(sd,hd,ivrt(nochp(i),oldv(v),r,topt2024(t)))        = af_nochp_int_d(sd,hd,i,v,r,"2023") ;
...
$if not  set frnucnormal    afmax_d(sd,hd,ivrt(nuc(i),oldv(v),"France",topt2024(t)))         = afmax_int_d(sd,hd,i,v,"France","2023") * 393.134 / 354.105 ;
...
afmin_nochp_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,topt2024(t))) = afmin_nochp_int_d(sd,hd,i,v,r,"2023") ;
afmax_nochp_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,topt2024(t))) = afmax_nochp_int_d(sd,hd,i,v,r,"2023") ;
...
* Other technologies
loop(tcri(t),
$if not  set nucmustrun     gen_af_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set nucmustrun     gen_af_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af_hydr(r,t)        = sum(ivrt(hyd(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * vrsc_exi_d(sd,hd,i,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t))) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * lifetime(i,v,r,t) * capt(i,v,r,t)) * 1e-3 ;
gen_af_wind(r,t)        = sum(ivrt(wind(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * vrsc_exi_d(sd,hd,i,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t))) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * lifetime(i,v,r,t) * capt(i,v,r,t)) * 1e-3 ;
gen_af_sola(r,t)        = sum(ivrt(sol(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * vrsc_exi_d(sd,hd,i,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t))) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * lifetime(i,v,r,t) * capt(i,v,r,t)) * 1e-3 ;
* Min/max issues
...
gen_af_coal(r,t)        = sum(ivrt_nochp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af_lign(r,t)        = sum(ivrt_nochp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set biomustrun     gen_af_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af_oil(r,t)         = sum(ivrt_nochp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
* CHP
...
gen_af_nochp_coal(r,t)  = sum(ivrt_nochp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af_nochp_lign(r,t)  = sum(ivrt_nochp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set biomustrun     gen_af_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_nochp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af_nochp_oil(r,t)   = sum(ivrt_nochp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
* NOCHP min/max issues
...
* * 2024+
loop(topt2024(t),
$if not  set nucmustrun     gen_af_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set nucmustrun     gen_af_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
$if not  set biomustrun     gen_af_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
$if not  set biomustrun     gen_af_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_nochp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
$if     set biomustrun     af_d(sd,hd,ivrt(bio(i),oldv(v),r,toptimize(t)))$(af_int_d(sd,hd,i,v,r,t) >= 0)  = round(af_int_d(sd,hd,i,v,r,t),8) ;
$if     set nucmustrun     af_d(sd,hd,ivrt(nuc(i),oldv(v),r,toptimize(t)))$(af_int_d(sd,hd,i,v,r,t) >= 0)  = round(af_int_d(sd,hd,i,v,r,t),8) ;
...
* Other technologies
loop(tcri(t),
$if not  set nucmustrun     gen_af2_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set nucmustrun     gen_af2_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
$if not  set biomustrun     gen_af2_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af2_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
* CHP
$if not  set chpmustrun     gen_af2_chp_ngas(r,t)    = sum(ivrt_chp(gas(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_coal(r,t)    = sum(ivrt_chp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_lign(r,t)    = sum(ivrt_chp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_biom(r,t)    = sum(ivrt_chp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_oil(r,t)     = sum(ivrt_chp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_ngas(r,t)    = sum(ivrt_chp(gas(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_coal(r,t)    = sum(ivrt_chp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_lign(r,t)    = sum(ivrt_chp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_biom(r,t)    = sum(ivrt_chp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_oil(r,t)     = sum(ivrt_chp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
* NOCHP
gen_af2_nochp_ngas(r,t)  = sum(ivrt_nochp(gas(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af2_nochp_coal(r,t)  = sum(ivrt_nochp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af2_nochp_lign(r,t)  = sum(ivrt_nochp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set biomustrun     gen_af2_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af2_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * af_nochp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af2_nochp_oil(r,t)   = sum(ivrt_nochp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
* NOCHP min/max issues
gen_afmin2_nochp_biom(r,t)   = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * afmin_nochp_d(sd,hd,i,v,r,t))) * 1e-3 ;
gen_afmax2_nochp_biom(r,t)   = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (afmax_nochp_d(sd,hd,i,v,r,t)-1)$afmax_nochp_d(sd,hd,i,v,r,t)))) * 1e-3 ;
) ;

* * 2024+
loop(topt2024(t),
$if not  set nucmustrun     gen_af2_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set nucmustrun     gen_af2_nucl(r,t)        = sum(ivrt(nuc(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
$if not  set biomustrun     gen_af2_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af2_biom(r,t)        = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
...
* CHP
$if not  set chpmustrun     gen_af2_chp_ngas(r,t)    = sum(ivrt_chp(gas(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_coal(r,t)    = sum(ivrt_chp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_lign(r,t)    = sum(ivrt_chp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_biom(r,t)    = sum(ivrt_chp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set chpmustrun     gen_af2_chp_oil(r,t)     = sum(ivrt_chp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_chp_d(sd,hd,i,v,r,t)-1)$af_chp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_ngas(r,t)    = sum(ivrt_chp(gas(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_coal(r,t)    = sum(ivrt_chp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_lign(r,t)    = sum(ivrt_chp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_biom(r,t)    = sum(ivrt_chp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set chpmustrun     gen_af2_chp_oil(r,t)     = sum(ivrt_chp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_chp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
* NOCHP
gen_af2_nochp_ngas(r,t)  = sum(ivrt_nochp(gas(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af2_nochp_coal(r,t)  = sum(ivrt_nochp(coa(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af2_nochp_lign(r,t)  = sum(ivrt_nochp(lig(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if not  set biomustrun     gen_af2_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
$if      set biomustrun     gen_af2_nochp_biom(r,t)  = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * af_nochp_d(sd,hd,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
gen_af2_nochp_oil(r,t)   = sum(ivrt_nochp(oil(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (af_nochp_d(sd,hd,i,v,r,t)-1)$af_nochp_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)))) * 1e-3 ;
* NOCHP min/max issues
gen_afmin2_nochp_biom(r,t)   = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * afmin_nochp_d(sd,hd,i,v,r,t))) * 1e-3 ;
gen_afmax2_nochp_biom(r,t)   = sum(ivrt_nochp(bio(i),oldv(v),r,toptimize(t)), sum((sd,hd), days(sd) * lifetime(i,v,r,t) * capt(i,v,r,"2023") * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (afmax_nochp_d(sd,hd,i,v,r,t)-1)$afmax_nochp_d(sd,hd,i,v,r,t)))) * 1e-3 ;
) ;

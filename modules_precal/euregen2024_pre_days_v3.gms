...
$if not  set biomustrun     af_nochp_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t))$(gen_co_nochp_biom(r,t) > 1) = (1 + (af_nochp_int(sd,hd,i,v,r,t)-1)$af_nochp_int(sd,hd,i,v,r,t)) *  gen_co_nochp_biom(r,t) ;
$if      set biomustrun     af_nochp_d(sd,hd,ivrt_nochp(bio(i),oldv(v),r,t)) = (1 + (af_nochp_int(sd,hd,i,v,r,t)-1)$af_nochp_int(sd,hd,i,v,r,t)) *  gen_co_nochp_biom(r,t) ;
...
$if not  set frnucnormal    af_d(sd_hd,ivrt(nuc(i),oldv(v),"France",topt2024(t)))         = af_int_d(sd_hd,i,v,"France","2023") * 393.134 / 354.105 ;
...
$if not  set frnucnormal    afmax_d(sd_hd,ivrt(nuc(i),oldv(v),"France",topt2024(t)))         = afmax_int_d(sd_hd,i,v,"France","2023") * 393.134 / 354.105 ;

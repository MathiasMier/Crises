...
inflow_d(sd,hd,jpump(j),v,r,t) = 0 ;
inflow_nv_d(sd,hd,jpump(j),r,t) = 0 ;

* Correct inflow with gen_resv to help calibration
dischrg_int(j,v,r) = dischrg(j,v,r) ;
dischrgnv_int(j,r) = dischrgnv(j,r) ;

$if not  set hours    dischrg(nvj(j),v,r) = 0.0 * dischrg_int(j,v,r) ;
$if not  set hours    dischrgnv(nvj(j),r) = 0.0 * dischrgnv_int(j,r) ;

$if      set hours    dischrg(nvj(j),v,r) = 0.1 * dischrg_int(j,v,r) ;
$if      set hours    dischrgnv(nvj(j),r) = 0.1 * dischrgnv_int(j,r) ;

inflowtot_h_d(jres(j),v,r,t)$(dchrgpen(j,v,r) > 0 and sum(vv, gcapt(j,vv,r,t) * ghours(j,vv,r)) > 0) = round(gen_resv(r,t) * gcapt(j,v,r,t) * ghours(j,v,r) / sum(vv, gcapt(j,vv,r,t) * ghours(j,vv,r)) / dchrgpen(j,v,r) * (1 + 0.5 * numberdays * 24 * dischrg(j,v,r)),4) ;
inflowtot_d(jres(j),v,r,t)$(dchrgpen(j,v,r) > 0 and sum(vv, gcapt(j,vv,r,t) * ghours(j,vv,r)) > 0) = round(gen_resv(r,t) * gcapt(j,v,r,t) * ghours(j,v,r) / sum(vv, gcapt(j,vv,r,t) * ghours(j,vv,r)) / dchrgpen(j,v,r) * (1 + 0.5 * numberdays * 24 * dischrg(j,v,r)),4) ;
inflowtot_nv_h_d(jres(j),r,t)$(dchrgpennv(j,r) > 0) = round(gen_resv(r,t) / dchrgpennv(j,r) * (1 + 0.5 * numberdays * 24 * dischrgnv(j,r)),4) ;
inflowtot_nv_d(jres(j),r,t)$(dchrgpennv(j,r) > 0) = round(gen_resv(r,t) / dchrgpennv(j,r) * (1 + 0.5 * numberdays * 24 * dischrgnv(j,r)),4) ;
inflow_d(sd,hd,jres(j),v,r,t) = round(inflowtot_d(j,v,r,t) * 1e+3 / 8760,4) ;
inflow_nv_d(sd,hd,jres(j),r,t) = round(inflowtot_nv_d(j,r,t) * 1e+3 / 8760,4) ;
...
$if not  set chpmustrun     X_d(sd,hd,i,v,r,t) =l=  XC(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) ;
$if      set chpmustrun     X_d(sd,hd,i,v,r,t) =e=  XC(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) ;              
...
$if not  set nucmustrun     X_d(sd,hd,i,v,r,t) =l=  XC(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) ;
$if      set nucmustrun     X_d(sd,hd,i,v,r,t) =e=  XC(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) ;
...
$if not  set biomustrun     X_d(sd,hd,i,v,r,t) =l=  XC(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) ;
$if      set biomustrun     X_d(sd,hd,i,v,r,t) =e=  XC(i,v,r,t) * (1 + (af_d(sd,hd,i,v,r,t)-1)$af_d(sd,hd,i,v,r,t)) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) ;
